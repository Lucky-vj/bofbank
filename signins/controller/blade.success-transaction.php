<?php
$data['PageName'] = 'Success Transaction';
$data['PageFile'] = 'success-transaction';
is_admin_session();
...
////// Total Trans Count
$totcnt = db_rows("SELECT COUNT(`transaction_id`) as total_trans FROM tbl_master_trans_table where 1  and transaction_status='Success'");
