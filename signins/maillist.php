...
include "controller/blade.maillist.php";
                      ...
                      ?>
                        <tr>
                          ...
                          <td><!--<a href="<?= $data['Admins']; ?>/approve-member<?= $data['ex']; ?>?client_id=<?= $result['client_id'] ?>" class="badge rounded-pill text-bg-warning">Manage</a>-->
                            ...
                            <a href="<?= $data['Admins']; ?>/maillist<?= $data['ex']; ?>?mid=<?= $result['client_id'] ?>&action=delete" onClick="return confirm('Are you Sure to Delete');" title="Delete <?= $data['PageName']; ?>"><i class="<?= $data['fwicon']['delete']; ?> text-danger mx-1"></i></a>
                          </td>
                        </tr>
                      <?php
