        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
              ...
              <!-- <h4 class="heading-ad">Login History (<?=$rows;?>)</h4> -->
...
if($value["logout_time"]==""){ $value["logout_time"]="Session Expired";}?>
  ...
  <td colspan="6"><div id="pagination_controls"><?php echo $paginationCtrls; ?></div></td>
