<?php
include "../common.php";
include "controller/blade.transaction.php";
?>
<!-- Left Sidebar End -->
<!-- ============================================================== -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <!-- <h4 class="heading-ad">All Transactions</h4> -->
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="font-size-14">Total Number of Credit<br>
                  </h5>
                </div>
        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              <div class="media">
                <div class="media-body">
                  <h5 class="font-size-14">Total Number of Debit<br>
                  </h5>
                </div>
              ...
              <div class="row">
                <div class="float-end col-sm-12">
                  ...
                  <?php if (isset($requrl) && $requrl) {
                    ...
                    <a href="<?= $data['Admins']; ?>/transaction<?= $data['ex'] ?>" class="btn btn-primary btn-sm" title="click to view all records">View All Records</a>
                  <? } ?>
                  <a class="btn btn-success btn-sm ms-1 my-1" href="<?= $data['Host']; ?>/mypdf/statement-excel<?= $data['ex'] ?>?view=all&str=<?= $pdfurl; ?>" title="Download Excel" target="_blank" style="float: right;" download="">
                    <i class="<?= $data['fwicon']['excel']; ?> text-light"></i>
                  </a>&nbsp;
                  <a class="btn btn-danger btn-sm my-1" href="<?= $data['Host']; ?>/mypdf/statement<?= $data['ex'] ?>?view=all&str=<?= $pdfurl; ?>" title="Download PDF" target="_blank" style="float: right;" download="">
                  ...
                  <table class="table table-centered table-nowrap mb-0">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><a href="?action=select&searchkey=<?= $_GET['searchkey']; ?>&key_name=<?= $_GET['key_name']; ?>&status=<?= $_GET['status']; ?>&date_range=<?= $_GET['date_range']; ?>&time_period=<?= $_GET['time_period']; ?>&date_1st=<?= $_GET['date_1st']; ?>&date_2nd=<?= $_GET['date_2nd']; ?>&order=transaction_date&otype=<?= $otype; ?>&pn=<?= $pn; ?>" title="Timestamp">Used Bank<i class="fa-solid fa-up-down fa-sm"></i></a></th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= !empty($tranlist['admin_transaction_date']) ? date('Y-m-d', strtotime($tranlist['admin_transaction_date'])) : ''; ?></td>
                          <td><a href="transaction-details<?= $data['ex']; ?>?tid=<?= $tranlist['transaction_id']; ?>" title="View Detail" class="text-center"><i class="<?= $data['fwicon']['eye']; ?> text-<?= $mscclr; ?>"></i></a></td>
                        </tr>
                      <?php } ?>
                      <tr class="pagination">
                        <td colspan="9">
