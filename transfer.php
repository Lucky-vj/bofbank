<?php
include "common.php";
include "controller/blade.transfer.php";
...
<div class="trans main-content transfer">
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <!-- <h4 class="heading-ad"><i class="<?= $data['fwicon']['arrow-right-arrow-left']; ?> fa-fw"></i>
              <?= $data['PageName']; ?>
              <br>
            </h4> -->
                    ...
                    <div class="row">
                      ...
                      <form method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4  my-3">
                            <div class="form-floating inner_page_input">
                              <input type="number" step="0.01" id="transaction_amount" name="transaction_amount" class="form-control" title="Amount" placeholder="Amount" required />
                          ...
                          <div class="col-md-4  my-3">
                            <div class="form-floating inner_page_input">
                              ...
                              <select class="form-select" name="trasnfer_reason" id="trasnfer_reason" title="Purpose for Transfer" required>
                                <option value="" selected="selected">select transfer reason</option>
                          ...
                          <div class="col-md-4  my-3">
                            <div class="form-floating inner_page_input">
                              <input class="form-control" name="other_trasnfer_reason" id="other_trasnfer_reason" type="text" title="Reference" placeholder="Reference" required>
                              <!--<label for="amount">Other Trasnfer Reason</label>-->
                            </div>
                          </div>
                        </div>
                        <!--<button type="submit" id="submit_beneficiary" class="btn btn-sm btn-success" name="quick_transfer" title="Quick Transfer" value="Quick Transfer"><i class="<?= $data['fwicon']['circle-plus']; ?>"></i> Submit</button>-->
                        <div class="form-group common-btn">
                          <!--<i class="<?= $data['fwicon']['circle-plus']; ?>"></i>-->
                          <button type="submit" id="submit_beneficiary" class="btn btn-sm submit-cmn-btn" name="quick_transfer" value="Submit">Submit</button>
                        </div>
                      </form>
                    </div>
                  </div>
                          ...
                          <div class="media">
                            <div class="media-body">
                              <div class="row font-size-14">
                                ...
                                <div class="col-sm-6 col-xl-6 my-2"><strong>Purpose</strong> -
                                  <?= $_SESSION['s_transaction_purpose']; ?>
                                </div>
                                <div class="col-sm-12 col-xl-12 my-2">
                                  <form method="post" name="frm" action="transfer.php" id="twofaformId">
                                    <input type="hidden" name="submit_transfer" value="Transfer" />
                                    <a href="transfer.php" class="btn btn-outline-success btn-sm template">Back</a>
                                    <?php if ($st == 1) { ?>
                                      <a class="btn btn-danger btn-sm template">Insufficient funds</a>
                                    <?php } else { ?>
                                    <?php } ?>
                                    <div class="form-group common-btn mb-5">
                                      <button type="submit" id="btn_submit" class="btn btn-sm submit-cmn-btn" name="btn_submit" value="Submit">Submit</button>
                                    </div>
                                  </form>
                                </div>
                              </div>
