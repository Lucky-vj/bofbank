        ...
        <div class="card-body">
		  ...
		  <div class="row bg-primary-subtle rounded mb-2 mx-0">
                  ...
                  <div class="row">
                      <div class="col-md-5">
                          <div class="form-group row">
							  ...
							  <div class="col-sm-8">
                              <input type="date" class="form-control form-control-sm my-2" name="start_date" required="">
                          </div></div>
                      </div>
                      <div class="col-md-5">
					  ...
					  <div class="form-group row">
							  ...
							  <div class="col-sm-8">
                              <input type="date" class="form-control form-control-sm my-2" name="end_date" required="">
                          </div></div>
					
                      </div>
                      <div class="col-md-2">
                          <button type="submit" class="btn btn-sm btn-primary my-2">Search</button>
                      </div>                                    
                  </div>
                </form>
              </div>
              <div class="col-md-4 my-2">
				...
				?>
				<div class="text-end my-2 px-1 "><a href="<?=$data['Admins'];?>/success-transaction<?=$data['ex']?>" class="badge text-bg-primary" title="click to view all records">View All Records</a></div>
				<? } ?>
			 <? if($rows > 0){ ?>
...
<td><?=$tranlist['transaction_date'];?></td>
...
<td><?=$tranlist['admin_transaction_date'];?></td>
