...
include "controller/blade.member-transaction.php";
...
$sql_query=" AND (sender_transaction_id is null || (sender_transaction_id IS NOT NULL && transaction_status='Success'))  AND member_id='$mid' ".$sql; 
$requrl="";
...
?>
                    <tr>
                      ...
                      <!--<td><?php /*?><a href="<?=$data['Admins'];?>/transaction-details<?=$data['ex'];?>?tid=<?=$tranlist['transaction_id'];?>" title="View Detail" class="text-center"><?php */?>
                        <?php /*?><a class="hrefmodal" data-tid="<?=$tranlist['transaction_id'];?>" data-href="<?=$data['Admins'];?>/transaction-details-view<?=$data['ex'];?>?tid=<?=$tranlist['transaction_id'];?>" title="<?=$tranlist['transaction_id'];?>" ><i class="<?=$data['fwicon']['eye'];?> text-<?=$mscclr;?>"></i></a><?php */?></td>
                    </tr>-->
                    <?php } ?>
                    <tr>
