<?php
include "../common.php";
include "controller/blade.success-transaction.php";
?>
<!-- Left Sidebar End -->
<!-- ============================================================== -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <!-- <h4 class="heading-ad">Success Transactions</h4> -->
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">Success Transactions</li>
              </ol>
            </div>
          </div>
        </div>
                  ...
                  <table class="table table-centered table-nowrap mb-0">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><a href="?action=select&searchkey=<?= $_GET['searchkey']; ?>&key_name=<?= $_GET['key_name']; ?>&status=<?= $_GET['status']; ?>&date_range=<?= $_GET['date_range']; ?>&time_period=<?= $_GET['time_period']; ?>&date_1st=<?= $_GET['date_1st']; ?>&date_2nd=<?= $_GET['date_2nd']; ?>&order=admin_transaction_date&otype=<?= $otype; ?>&pn=<?= $pn; ?>" title="Settlement Date">SettelementDate<i class="fa-solid fa-up-down fa-sm"></i></a></th>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><span class="badge rounded-pill text-bg-success">
