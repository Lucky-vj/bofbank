...

{
    ...
    public $Host = 'mail.bofbank.com'; // chnage localhost to mail.xeyso.com by vikash
    ...
    public $Port = 465; // chnage 25 to 465 by vikash
    ...
    public $SMTPSecure = 'ssl';  // Change blank to ssl by vikash
    ...
    public $SMTPAuth = true; // chnage false to true by vikash
    ...
    public $Username = 'mailers@bofbank.com';// chnage blank to by vikash
    ...
    public $Password = 'India@990@';// chnage blank to by vikash
